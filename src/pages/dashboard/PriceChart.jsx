  ...
  return (
    <div className="flex relative">
      <div className="">
        ...
        <div>
          <div className="absolute bottom-[22px]  right-[20px]  md:right-[60px]  lg:right-[23px]    xl:right-[42px]  2xl:right-[60px] w-[88%]">
            <img src={vector1} alt="vector1" className="w-[100%]" />
          </div>
          <div className="absolute top-[3px]  right-[20px]   md:right-[60px] lg:right-[23px] xl:right-[42px]  2xl:right-[60px] w-[88%]">
